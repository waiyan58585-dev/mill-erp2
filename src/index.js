...
export default function MillERP() {
  ...
  if (!userRole) {
    return (
      <div className="flex items-center justify-center h-screen bg-gray-900 font-sans relative">
        {dialogConfig && (
          <div className="fixed inset-0 bg-gray-900/80 backdrop-blur-sm z-[9999] flex items-center justify-center p-4">
             <div className="bg-white rounded-3xl shadow-2xl w-full max-w-sm overflow-hidden animate-in zoom-in-95 duration-200">
                <div className="p-8 text-center">
                   ...
                   <h3 className="text-xl font-bold text-gray-800 mb-8 whitespace-normal break-words leading-relaxed">{dialogConfig.message}</h3>
        ...
        <div className="bg-white p-8 rounded-3xl shadow-2xl w-full max-w-md animate-in zoom-in-95 duration-300">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            <div>
              <input type="password" autoFocus placeholder="PIN နံပါတ် (****)" value={pinInput} onChange={e => setPinInput(e.target.value)} className="w-full text-center text-3xl tracking-[1em] p-4 bg-gray-50 border-2 border-gray-200 rounded-xl outline-none focus:border-blue-500 font-black text-gray-800 transition-colors" required />
            </div>
            ...
            <div className="animate-in fade-in duration-300">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    ...
                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200 border-l-4 border-l-green-500">
                        ...
                        <p className="text-3xl font-black text-gray-800">{todayDeliveries} <span className="text-sm">ကြိမ်</span></p>
                    </div>
                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200 border-l-4 border-l-red-500">
                        ...
                        <p className="text-3xl font-black text-red-600">{totalDebt > 0 ? totalDebt.toLocaleString() : 0} <span className="text-sm text-gray-500">Ks</span></p>
                    </div>
                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200 border-l-4 border-l-orange-500">
                        <p className="text-sm font-bold text-gray-500 mb-2">ဘေလ်ဖွင့်ရန်ကျန်သော စာရင်း</p>
                        <p className="text-3xl font-black text-orange-600">{pendingBills} <span className="text-sm text-gray-500">ဘောက်ချာ</span></p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200">
                        <h3 className="font-bold text-gray-800 mb-4 flex items-center"><Calculator size={18} className="mr-2 text-gray-500"/> ဘေလ်ရှင်းရန်ကျန်သော စာရင်းများ</h3>
                        <div className="space-y-3">
                            ...
                            {pendingBills === 0 && <p className="text-sm text-gray-500 text-center py-4 font-medium">ရှင်းရန်ကျန် စာရင်းမရှိပါ။</p>}
                        </div>
                        <button onClick={() => setActiveView('admin')} className="w-full mt-4 py-3 bg-gray-100 hover:bg-gray-200 text-gray-700 font-bold rounded-xl text-sm transition-colors">ငွေစာရင်းဌာနသို့ သွားမည်</button>
                    </div>
                </div>
            </div>
        );
          ...
          <form onSubmit={handleAddJob} className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-6 gap-5">
              ...
              <div className="col-span-1 md:col-span-2">
                 <label className="block text-xs font-bold text-gray-600 mb-1.5 flex items-center"><MapPin size={12} className="mr-1"/> ချထားမည့် သိုလှောင်ရုံ/နေရာ (စပါးဂိုဒေါင်)</label>
                 <input type="text" list="storageLocations" value={newJob.storage} onChange={e=>setNewJob({...newJob, storage: e.target.value})} className="w-full p-2.5 border border-gray-300 rounded-lg outline-none focus:ring-2 focus:ring-blue-500 text-sm bg-gray-50 text-gray-900" required/>
                    ...
                    return (
                      <tr key={job.id} className={`hover:bg-gray-50 ${isFullyDelivered ? 'opacity-50' : ''}`}>
                        ...
                        <td className="p-4 align-top text-center">
                            {!isFullyDelivered && (
                                <button onClick={() => handleDeliveryClick(job)} className="bg-gray-800 hover:bg-gray-900 text-white font-bold px-4 py-2.5 rounded-xl text-xs shadow-md transition-colors flex items-center mx-auto">
            ...
            <div className="fixed inset-0 bg-gray-900/70 backdrop-blur-sm z-[9999] flex items-center justify-center p-4">
                <div className="bg-white rounded-3xl shadow-2xl w-full max-w-lg overflow-hidden animate-in zoom-in-95 duration-200 max-h-[90vh] flex flex-col">
                    <div className="px-6 py-5 border-b bg-gray-50 flex justify-between items-center shrink-0">
                        <h3 className="font-black text-lg text-gray-800 flex items-center"><Truck className="mr-2 text-gray-600"/> ကုန်ထုတ်ပေးမှု မှတ်တမ်း (Delivery)</h3>
                        <button onClick={() => setDeliveryModal(null)} className="text-gray-400 hover:text-red-500"><X size={20}/></button>
                    </div>
  ...
  const renderInventoryView = () => {
    ...
    return (
      <div className="animate-in fade-in duration-300">
        <h2 className="text-2xl font-bold text-gray-800 mb-6 flex items-center"><Package className="mr-3 text-blue-600"/> စက်ပိုင် ဆန်/ဖွဲနု စာရင်း</h2>
        <div className="bg-gradient-to-r from-gray-900 to-gray-800 rounded-3xl shadow-xl p-8 mb-8 relative overflow-hidden">
           ...
           <h3 className="text-xl font-black mb-6 text-blue-400 flex items-center relative z-10"><ArrowDownToLine size={24} className="mr-2"/> စက်မှ ပြန်လည်ဝယ်ယူထားသော စာရင်းချုပ်</h3>
           <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
              <div className="bg-gray-800/80 p-6 rounded-2xl border border-gray-700 backdrop-blur-sm">
                 <p className="text-gray-400 text-sm font-bold uppercase tracking-wider mb-2">ဖွဲနု စုစုပေါင်း</p>
                 <div className="text-4xl font-black text-white">{totalPurchasedBran} <span className="text-base font-medium text-gray-400">အိတ်</span></div>
              </div>
              <div className="bg-gray-800/80 p-6 rounded-2xl border border-gray-700 backdrop-blur-sm">
                 <p className="text-gray-400 text-sm font-bold uppercase tracking-wider mb-2">အကြမ်းဆန် / ဗိုက်ဖြူ (By-product)</p>
                 <div className="text-4xl font-black text-white">{totalPurchasedByproduct} <span className="text-base font-medium text-gray-400">အိတ်</span></div>
              </div>
              <div className="bg-gray-800/80 p-6 rounded-2xl border border-gray-700 backdrop-blur-sm">
                 <p className="text-gray-400 text-sm font-bold uppercase tracking-wider mb-2">Reject ဆန်အမည်း</p>
                 <div className="text-4xl font-black text-white">{totalPurchasedReject} <span className="text-base font-medium text-gray-400">အိတ်</span></div>
              </div>
           </div>
        </div>
      </div>
          ...
          {searchedJobs.map(job => {
            ...
            return (
              <div key={job.id} className="bg-white rounded-3xl shadow-xl border border-gray-200 overflow-hidden flex flex-col">
                ...
                ) : <div className="p-8 flex-1 flex flex-col justify-center items-center bg-gray-50/50 border-t border-gray-100"><button onClick={() => setActiveJobId(job.id)} className={`bg-white font-bold py-4 px-8 rounded-2xl border-2 shadow-sm flex items-center hover:scale-105 ${isAdvance ? 'text-green-600 border-green-200 hover:bg-green-50' : 'text-blue-600 border-blue-200 hover:bg-blue-50'}`}><Calculator size={22} className="mr-2"/> ဘေလ်တွက်ချက်ရန် နှိပ်ပါ</button></div>}
              </div>
            )
          })}
        </div>
      ...
      <div className="animate-in fade-in duration-300 relative">
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="relative w-72">
            <input type="text" placeholder="အမည်ဖြင့် ရှာရန်..." value={ledgerSearchQuery} onChange={e=>setLedgerSearchQuery(e.target.value)} className="w-full pl-10 pr-4 py-2.5 border-2 border-gray-200 bg-gray-50 text-gray-900 rounded-xl outline-none focus:border-blue-500 font-bold"/>
        ...
        <div className="space-y-4 pb-20">
            ...
            <div key={cust.name} className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden transition-all">
              ...
              {expandedCustomer === cust.name && (
                <div className="p-0 border-t border-gray-200 animate-in slide-in-from-top-2">
                  <div className="grid grid-cols-2 bg-gray-100/50 p-4 border-b border-gray-200">
                  ...
                  <div className="p-4 bg-white border-b border-gray-200">
                     ...
                     <textarea
                       className="w-full p-3 text-sm border border-gray-300 bg-gray-50 text-gray-900 rounded-lg outline-none focus:border-blue-500 resize-none h-20"
                                  ...
                                  {h.deliveryLogs && h.deliveryLogs.length > 0 && (
                                      <div className="mt-3 pt-3 border-t border-gray-200 border-dashed space-y-2">
                                          ...
                                          {h.deliveryLogs.map((log, idx) => (
                                              <div key={idx} className="bg-gray-100 p-2 rounded-lg text-xs text-gray-700">
                                                  ...
                                                  <div className="flex flex-wrap gap-1">
                                                      {Object.entries(log.items).map(([key, val]) => val > 0 && (
                                                          <span key={key} className="bg-white border border-gray-200 px-1.5 py-0.5 rounded text-[10px]">{key}: {val} အိတ်</span>
                                                      ))}
                                                  </div>
                                              </div>
                                          ))}
          ...
          {filteredCustomers.length === 0 && <p className="text-center text-gray-500 py-12 bg-white rounded-2xl border border-gray-200 border-dashed font-bold text-lg">ရှာဖွေမှုနှင့် ကိုက်ညီသော ဖောက်သည် မရှိပါ။</p>}
        </div>
          ...
          <div className="fixed inset-0 bg-gray-900/60 backdrop-blur-sm z-[9999] flex items-center justify-center p-4">
            <div className="bg-white rounded-3xl shadow-2xl w-full max-w-sm overflow-hidden animate-in zoom-in-95 duration-200">
              <div className={`px-6 py-5 border-b flex justify-between items-center ${paymentModal.type === 'receive' ? 'bg-red-50 border-red-100' : 'bg-green-50 border-green-100'}`}>
                ...
                <button disabled={isLoading} onClick={() => setPaymentModal(null)} className="text-gray-400 hover:text-gray-600"><X size={20}/></button>
              </div>
              <form onSubmit={handlePaymentSubmit} className="p-6">
                ...
                <div>
                  ...
                  <input type="number" required autoFocus value={paymentAmount} onChange={e=>setPaymentAmount(e.target.value)} className="w-full p-4 border-2 border-gray-300 bg-gray-50 text-gray-900 rounded-xl outline-none focus:border-blue-500 text-xl font-bold text-center" placeholder="0" min="1"/>
                </div>
  ...
  const renderMenu = () => {
    ...
    if (userRole === 'admin') {
      menus = [
        ...
        { id: 'paddy_warehouse', name: 'စပါးဂိုဒေါင်', icon: Factory, color: 'text-orange-600', activeBg: 'bg-orange-50 border-orange-100 text-gray-800' },
        ...
        { id: 'rice_warehouse', name: 'ဆန်ဂိုဒေါင်', icon: Factory, color: 'text-green-600', activeBg: 'bg-green-50 border-green-100 text-gray-800' },
        { id: 'inventory', name: 'စက်ပိုင် ဆန်စာရင်း', icon: Package, color: 'text-blue-600', activeBg: 'bg-blue-50 border-blue-100 text-gray-800' },
        { id: 'admin', name: 'ငွေစာရင်း (POS)', icon: Calculator, color: 'text-red-600', activeBg: 'bg-red-50 border-red-100 text-gray-800' },
        { id: 'customers', name: 'ဖောက်သည် အကြွေး', icon: Users, color: 'text-gray-700', activeBg: 'bg-gray-100 border-gray-200 text-gray-800' },
      ];
        ...
        <div className="space-y-1.5">
          {menus.map(menu => (
            <button 
              ...
              className={`w-full flex items-center space-x-3 px-4 py-3.5 rounded-xl transition-all font-bold border ${activeView === menu.id ? `${menu.activeBg} ${menu.color}` : 'border-transparent text-gray-600 hover:bg-gray-100 hover:text-gray-900'}`}
            >
  ...
  return (
    <div className="flex h-screen bg-[#f1f5f9] font-sans relative">
              ...
              <div className="p-8 text-center">
                 ...
                 <div className="flex gap-3 justify-center">
                    {dialogConfig.type === 'confirm' && (
                       <button onClick={() => setDialogConfig(null)} className="flex-1 py-3 bg-gray-100 hover:bg-gray-200 text-gray-700 font-bold rounded-xl transition-colors border border-gray-200">မလုပ်တော့ပါ</button>
                    )}
                    <button onClick={() => {
      ...
      <div className="w-[280px] bg-white border-r border-gray-200 flex flex-col shadow-sm z-20">
