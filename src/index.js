...
export default function MillERP() {
  ...
  // Delivery Form (Partial Delivery)
          ...
          <div className="fixed inset-0 bg-slate-900/80 backdrop-blur-sm z-[9999] flex items-center justify-center p-4">
             <div className="bg-white rounded-3xl shadow-2xl w-full max-w-sm overflow-hidden animate-in zoom-in-95 duration-200">
                <div className="p-8 text-center">
                   ...
                   <button onClick={() => setDialogConfig(null)} className="w-full py-3.5 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl text-lg shadow-md transition-colors">အိုကေ</button>
                </div>
             </div>
          </div>
        )}
            ...
            <div className="animate-in fade-in duration-300">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    ...
                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 border-l-4 border-l-rose-500">
                        ...
                        <p className="text-3xl font-black text-rose-600">{totalDebt > 0 ? totalDebt.toLocaleString() : 0} <span className="text-sm text-slate-500">Ks</span></p>
                    </div>
                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 border-l-4 border-l-amber-500">
                        ...
                        <p className="text-3xl font-black text-amber-600">{pendingBills} <span className="text-sm text-slate-500">ဘောက်ချာ</span></p>
                    </div>
                </div>
                    ...
                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
                        ...
                        <div className="space-y-4">
                            <div className="flex justify-between items-center bg-slate-50 p-4 rounded-xl">
                                ...
                                <span className="bg-amber-100 text-amber-800 px-3 py-1 rounded-lg font-black">{pendingDry}</span>
                            </div>
                            <div className="flex justify-between items-center bg-slate-50 p-4 rounded-xl">
                            ...
                            <div className="flex justify-between items-center bg-slate-50 p-4 rounded-xl">
                                ...
                                <span className="bg-indigo-100 text-indigo-800 px-3 py-1 rounded-lg font-black">{pendingSort}</span>
                            </div>
                        </div>
                    </div>
            ...
            <div className="animate-in fade-in duration-300">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    ...
                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 border-l-4 border-l-amber-500">
                        ...
                        <p className="text-3xl font-black text-amber-600">{pendingDry} <span className="text-sm">စာရင်း</span></p>
                    </div>
                ...
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
                    ...
                    <div className="flex gap-4">
                        ...
                        <button onClick={()=>setActiveView('paddy_warehouse')} className="bg-amber-600 text-white px-6 py-3 rounded-xl font-bold hover:bg-amber-700 shadow-md">စပါးဂိုဒေါင်သို့ သွားမည်</button>
                    </div>
                </div>
            </div>
        );
            ...
            <div className="animate-in fade-in duration-300">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    ...
                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 border-l-4 border-l-indigo-500">
                        ...
                        <p className="text-3xl font-black text-indigo-600">{pendingSort} <span className="text-sm">စာရင်း</span></p>
                    </div>
                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 border-l-4 border-l-emerald-500">
                        <p className="text-sm font-bold text-slate-500 mb-2">ယနေ့ ဆန်ထုတ်ပေးမှု</p>
                        <p className="text-3xl font-black text-emerald-600">{todayDeliveries} <span className="text-sm">ကြိမ်</span></p>
                    </div>
                </div>
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
                    <h3 className="font-bold text-slate-800 mb-4">လုပ်ဆောင်ရန်</h3>
                    <div className="flex gap-4">
                        ...
                        <button onClick={()=>setActiveView('rice_warehouse')} className="bg-emerald-600 text-white px-6 py-3 rounded-xl font-bold hover:bg-emerald-700 shadow-md">ဆန်ဂိုဒေါင်သို့ သွားမည်</button>
                    </div>
                </div>
            </div>
        );
  ...
  const renderGateView = () => {
    const handleAddJob = async (e) => {
      ...
      // All intakes go to warehouse first. 
      // If Nawali -> stored_nawali. If Paddy -> stored_paddy (with moisture recorded).
      ...
      const jobData = {
        ...
        status: initialStatus, date: newJob.date, deliveryLogs: [] // Initialize delivery logs
      };
          ...
          <form onSubmit={handleAddJob} className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-6 gap-5">
              ...
              <div className="col-span-1 md:col-span-2">
                 <label className="block text-xs font-bold text-slate-600 mb-1.5 flex items-center"><MapPin size={12} className="mr-1"/> ချထားမည့် သိုလှောင်ရုံ/နေရာ (စပါးဂိုဒေါင်)</label>
  ...
  const renderPaddyWarehouseView = () => {
    ...
    // Drying Operations (Moved from Gate to here, since Dryer is closely linked to Paddy)
    ...
    return (
      <div className="animate-in fade-in duration-300 space-y-8">
        <h2 className="text-2xl font-bold text-slate-800 flex items-center"><Package className="mr-3 text-amber-600"/> စပါး / နဝလီ ဂိုဒေါင် နှင့် အခြောက်ခံစက်</h2>
        ...
        <div className="bg-white rounded-2xl border border-amber-200 overflow-hidden shadow-sm">
           <div className="bg-amber-50 p-5 border-b border-amber-200">
               <h3 className="font-bold text-amber-900">ဂိုဒေါင်တွင်း လက်ကျန်စပါး/နဝလီ (စက်ချရန်အသင့်)</h3>
           </div>
                      ...
                      <td className="p-4 align-middle">
                         {job.entryType === 'nawali' ? (
                             ...
                             <div>
                                 ...
                                 {job.moisture === 'အစို' ? <span className="bg-red-50 text-red-600 px-2 py-1 rounded text-xs font-bold border border-red-200">အစို (အခြောက်ခံရန်လို)</span> : <span className="bg-amber-50 text-amber-700 px-2 py-1 rounded text-xs font-bold border border-amber-200">အခြောက် (ကြိတ်ရန်အသင့်)</span>}
                             </div>
                         )}
                      </td>
                      <td className="p-4 align-middle">
  ...
  const renderRiceWarehouseView = () => {
    ...
    const riceJobs = jobs.filter(j => ['ready_to_bill', 'billed'].includes(j.status) && j.purpose !== 'dry_only');
    ...
    const handleDeliveryClick = (job) => {
        ...
        // Check if anything is left to deliver (excluding sold items)
    ...
    return (
      <div className="animate-in fade-in duration-300 relative">
        <h2 className="text-2xl font-bold text-slate-800 mb-6 flex items-center"><Factory className="mr-3 text-emerald-600"/> ဆန် နှင့် ထွက်ကုန် ဂိုဒေါင် (Delivery)</h2>
                  ...
                  {riceJobs.map(job => {
                    ...
                    return (
                      <tr key={job.id} className={`hover:bg-slate-50 ${isFullyDelivered ? 'opacity-50' : ''}`}>
                        ...
                        <td className="p-4 align-top">
                           {isFullyDelivered ? (
                               <span className="text-sm font-bold text-emerald-600 bg-emerald-50 px-3 py-1 rounded">ထုတ်ယူပြီးပါပြီ</span>
                           ) : (
                               <div className="flex flex-wrap gap-2">
                                  {rem.out1 > 0 && <div className="text-xs font-bold bg-emerald-50 text-emerald-800 px-2 py-1 rounded border border-emerald-100">{labels[0]}: {rem.out1} အိတ်</div>}
                                  ...
                                  {rem.broken234 > 0 && <div className="text-xs font-bold bg-sky-50 text-sky-800 px-2 py-1 rounded border border-sky-100">၂၃၄ ဆန်ကွဲ: {rem.broken234} အိတ်</div>}
                                  {rem.bran > 0 && job.billData?.branOption !== 'sell' && <div className="text-xs font-bold bg-amber-50 text-amber-800 px-2 py-1 rounded border border-amber-100">ဖွဲနု: {rem.bran} အိတ်</div>}
                               </div>
                           )}
            ...
            <div className="fixed inset-0 bg-slate-900/70 backdrop-blur-sm z-[9999] flex items-center justify-center p-4">
                <div className="bg-white rounded-3xl shadow-2xl w-full max-w-lg overflow-hidden animate-in zoom-in-95 duration-200 max-h-[90vh] flex flex-col">
                    <div className="px-6 py-5 border-b bg-slate-50 flex justify-between items-center shrink-0">
                        <h3 className="font-black text-lg text-slate-800 flex items-center"><Truck className="mr-2 text-slate-600"/> ကုန်ထုတ်ပေးမှု မှတ်တမ်း (Delivery)</h3>
                    ...
                    <form onSubmit={handleDeliverySubmit} className="p-6 overflow-y-auto flex-1 space-y-4">
                        <div className="bg-emerald-50 p-3 rounded-xl border border-emerald-100 mb-2">
                            <p className="text-sm font-bold text-emerald-900">{deliveryModal.job.customer} ({deliveryModal.job.id})</p>
                            <p className="text-xs text-emerald-700">ထုတ်ပေးမည့် အရေအတွက်များကို အောက်တွင် ဖြည့်ပါ။</p>
                        </div>
                        ...
                        <div className="border-t border-slate-200 pt-4 mt-4 space-y-3">
                            ...
                            {deliveryModal.available.out3 > 0 && deliveryModal.job.billData?.rejectOption !== 'sell' && (
                                <div className="flex items-center justify-between bg-slate-50 p-2 rounded border border-slate-200">
                                    ...
                                    <input type="number" min="0" max={deliveryModal.available.out3} placeholder="0" value={deliveryInput.items.out3 || ''} onChange={e=>setDeliveryInput({...deliveryInput, items: {...deliveryInput.items, out3: e.target.value}})} className="w-24 p-2 border border-slate-300 rounded text-right outline-none focus:border-blue-500 font-bold"/>
                                </div>
                            )}
  ...
  const renderInventoryView = () => {
    ...
    jobs.forEach(job => {
      if (job.status === 'billed' || job.status === 'delivered' || job.billData) {
                      ...
                      {isAdvance && (
                        <>
                           <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm">
                             ...
                             <input type="number" value={billInput.dryingRate} onChange={e=>setBillInput({...billInput, dryingRate: e.target.value})} className="w-full p-3 border-2 border-slate-200 bg-slate-50 text-slate-900 rounded-xl outline-none focus:border-emerald-500 font-bold" placeholder="ကျပ်"/>
                           ...
                           <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm">
                             ...
                             <input type="number" value={billInput.otherExp} onChange={e=>setBillInput({...billInput, otherExp: e.target.value})} className="w-full p-3 border-2 border-slate-200 bg-slate-50 text-slate-900 rounded-xl outline-none focus:border-emerald-500 font-bold" placeholder="0"/>
                           </div>
                        </>
                      )}
      ...
      <div className="animate-in fade-in duration-300 relative">
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="relative w-72">
            <input type="text" placeholder="အမည်ဖြင့် ရှာရန်..." value={ledgerSearchQuery} onChange={e=>setLedgerSearchQuery(e.target.value)} className="w-full pl-10 pr-4 py-2.5 border-2 border-slate-200 bg-slate-50 text-slate-900 rounded-xl outline-none focus:border-indigo-500 font-bold"/>
              ...
              {expandedCustomer === cust.name && (
                <div className="p-0 border-t border-slate-200 animate-in slide-in-from-top-2">
                  ...
                  <div className="p-4 bg-white border-b border-slate-200">
                     ...
                     <textarea
                       className="w-full p-3 text-sm border border-slate-300 bg-slate-50 text-slate-900 rounded-lg outline-none focus:border-indigo-500 resize-none h-20"
                          ...
                          <tr key={h.id} className="hover:bg-slate-50">
                            ...
                            <td className="py-4 px-4 align-top">
                              {h.status === 'payment' ? (
                                ...
                                <div>
                                  ...
                                  {h.status === 'billed' ? (
                                      <span className="text-[10px] text-indigo-600 font-bold uppercase mt-1 inline-block bg-indigo-50 px-2 py-0.5 rounded">ဘေလ်ရှင်းပြီး</span>
                                  ) : (
                                      <span className="text-[10px] text-amber-600 font-bold uppercase mt-1 inline-block bg-amber-50 px-2 py-0.5 rounded">လုပ်ဆောင်ဆဲ</span>
                                  )}
                            ...
                            <td className="py-4 px-4 text-right font-black text-[15px] align-top">
                              {h.status === 'payment' ? (
                                ...
                                <span className={h.billData.netTotal < 0 ? 'text-emerald-600' : 'text-slate-800'}>
            ...
            <div className="bg-white rounded-3xl shadow-2xl w-full max-w-sm overflow-hidden animate-in zoom-in-95 duration-200">
              ...
              <form onSubmit={handlePaymentSubmit} className="p-6">
                ...
                <div>
                  ...
                  <input type="number" required autoFocus value={paymentAmount} onChange={e=>setPaymentAmount(e.target.value)} className="w-full p-4 border-2 border-slate-300 bg-slate-50 text-slate-900 rounded-xl outline-none focus:border-indigo-500 text-xl font-bold text-center" placeholder="0" min="1"/>
                </div>
  ...
  const renderMenu = () => {
    ...
    if (userRole === 'admin') {
      menus = [
        { id: 'dashboard', name: 'Dashboard', icon: LayoutDashboard, color: 'text-indigo-600', activeBg: 'bg-indigo-50 border-indigo-100 text-slate-800' },
        ...
        { id: 'sorting', name: 'Color Sorting', icon: ScanLine, color: 'text-indigo-600', activeBg: 'bg-indigo-50 border-indigo-100 text-slate-800' },
        ...
        { id: 'admin', name: 'ငွေစာရင်း (POS)', icon: Calculator, color: 'text-rose-600', activeBg: 'bg-rose-50 border-rose-100 text-slate-800' },
  ...
  return (
    <div className="flex h-screen bg-[#f1f5f9] font-sans relative">
      {/* Absolute Root Level Custom Dialog (Prevents freeze due to rendering issues) */}
      {dialogConfig && (
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-[9999] flex items-center justify-center p-4">
           <div className="bg-white rounded-3xl shadow-2xl w-full max-w-sm overflow-hidden animate-in zoom-in-95 duration-200">
              <div className="p-8 text-center">
                 <AlertCircle size={48} className={`mx-auto mb-4 ${dialogConfig.type === 'confirm' ? 'text-red-500' : 'text-blue-500'}`} />
